  ...
  return (
    <div className='max-w-7xl mx-auto my-10 '>
      ...
      <div className='my-4'>
        ...
        <h2 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum</span></h2>
        ...
        <h2 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>17-07-2024</span></h2>
      </div>
    </div>
  )
}
